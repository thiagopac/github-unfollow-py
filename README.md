...
To use this script, you need to have Python installed. If you do not have Python installed, you can download it from [python.org](https://python.org/).
